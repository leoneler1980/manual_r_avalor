...
Si has instalado programas en tu computadora por tu propia cuenta, puedes saltarte esta sección, ya que el proceso de instalación de R es muy intuitivo. Si necesitas ayuda para la instalación, continúa leyendo.
...
![Si seguiste las instrucciones paso a paso, debería aparecer en el escritorio de tu computadora el ícono de R. Inmediatamente abres el programa, te aparecerá la **consola de R**](imagenes/01consolar.png "Figura 2.")

Esta es la consola de R, aquí podemos comenzar a usar el programa. Como notarás, es un poco complejo y se ve poco atractivo usar solamente la consola, por suerte tenemos disponible aditamentos o accesorios que nos permiten trabajar más fácil con R y hacer de su aprendizaje un proceso más amigable. Para estos fines, usaremos **RStudio** de [Posit®](https://posit.co/ "Página web donde descargar Rstudio")
...
Hay paquetes creados por epidemiólogos, para epidemiólogos como el {**epitools}** [@aragon_epitools_2020] o {**epikit}** [@spina_epikit_2023] que nos permiten con pocos comando o funciones hacer tareas como calcular medidas de asociación (OR, Riesgo relativo) y facilitar los análisis en epidemiología y otros paquetes que hacen las tareas de análisis de datos como son el {**openxlsx}** [@schauberger_openxlsx_2023] para manipular y crear archivos de Excel o el muy famoso y aclamado paquete **tidyverse** [@wickham_tidyverse_2023]del cual hay este paquete hay libros escritos para el procesamiento y manejo de datos por mencionar algunos.
